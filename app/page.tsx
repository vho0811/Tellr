...
export default function Home() {
  return (
      <main className="flex-1 flex flex-col">
        <section className="flex-1 grid grid-cols-1 lg:grid-cols-2 h-screen">

        <div className="flex flex-col space-y-5 bg-[#EDE9F7] items-center justify-center order-1 lg:-order-1 h-full p-10">
